...
namespace ControlHoras
{
    public partial class Form1 : Form
    {
        ...
        private void Agregar_Click(object sender, EventArgs e)
        {
            ...
            cbc.Items.Add("Guardia 1");
            cbc.Items.Add("Guardia 2");
        ...
        {
            Planificacion pl = new Planificacion(txtCliente.Text, txtServicio.Text, dgvHoras);
            pl.ShowDialog(this);            
        ...
        {
            if (e.KeyCode == Keys.Enter && mtServicio.MaskFull)
            {
