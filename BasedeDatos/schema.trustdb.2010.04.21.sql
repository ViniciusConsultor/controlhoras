...
CREATE TABLE `eventoshistorialempleado` (
  ...
  CONSTRAINT `eventoshistorialempleado_ibfk_1` FOREIGN KEY (`IdEmpleado`) REFERENCES `empleados` (`IdEmpleado`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `extrasliquidacionempleado` (
  ...
  KEY `fk_idEmpleado` (`IdEmpleado`),
  CONSTRAINT `extrasliquidacionempleado_ibfk_1` FOREIGN KEY (`IdEmpleado`) REFERENCES `empleados` (`IdEmpleado`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2010-04-21  1:43:50
