...
CREATE TABLE `empleados` (
  ...
  UNIQUE KEY `NumeroDocumentoUnico` (`NumeroDocumento`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `escalafonempleado` (
  ...
  KEY `ix_IdEscaladonEmpleado` (`IdEscalafonEmpleado`),
...
CREATE TABLE `horarioescalafon` (
  ...
  KEY `idEscalafonEmpleado` (`idEscalafonEmpleado`),
  CONSTRAINT `horarioescalafon_ibfk_1` FOREIGN KEY (`idEscalafonEmpleado`) REFERENCES `escalafonempleado` (`IdEscalafonEmpleado`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `horasgeneradasescalafon` (
  ...
  KEY `ix_NroEmpleado` (`NroEmpleado`)
...
CREATE TABLE `motivoscambiosdiarios` (
  ...
  `NumeroServicio` mediumint(8) unsigned NOT NULL,
  `NroEmpleado` mediumint(8) unsigned NOT NULL,
  `IdHorasGeneragasEscalafon` bigint(20) NOT NULL,
  ...
  KEY `IdHorasGeneragasEscalafon` (`IdHorasGeneragasEscalafon`),
  ...
  CONSTRAINT `motivoscambiosdiarios_ibfk_4` FOREIGN KEY (`IdHorasGeneragasEscalafon`) REFERENCES `horasgeneradasescalafon` (`IdHorasGeneradasEscalafon`)
...
-- Dump completed on 2010-08-30  0:56:23
